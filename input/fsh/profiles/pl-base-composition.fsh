...
* type contains 
    ...
    p1DocumentClassType 1..1 MS
* type[loincDocumentType] from $fhir-document-type
* type[p1DocumentClassType] from PLP1DocumentClassType
* subject 1..1 MS
...
* attester[authenticator].mode = #personal | #professional
* attester[legalAuthenticator].time 1..1 MS
* attester[legalAuthenticator].party 1..1 MS
* attester[legalAuthenticator].party only Reference(PLBasePractitioner)
* custodian 1..1 MS
